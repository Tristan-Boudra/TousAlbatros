...
const ProjectLeft = (props) => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row items-center border rounded-xl p-5 relative">
      ...
      <div className="flex flex-col justify-center w-full md:w-1/2 text-left md:text-right">
